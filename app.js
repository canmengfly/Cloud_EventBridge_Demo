...
// var eventbridgeController = require('./controllers/eventbridgeController.ts')



topicController(app, ui);
queueController(app, ui);
mysqlController(app, ui);
// eventbridgeController(app, ui);
...
app.get('/client', function (req, res) {
    res.setHeader('Content-Type', 'text/html');
    res.render('./client', {ui: ui})
})

app.post('/cart', function (req, res) {
    res.setHeader('Content-Type', 'text/html');
    res.render('./cart', {ui: ui})
})

app.get('/checkout', function (req, res) {
    res.setHeader('Content-Type', 'text/html');
    res.render('./checkout', {ui: ui})
})

app.post('/order', function (req, res) {
    res.setHeader('Content-Type', 'text/html');
    res.render('./order', {ui: ui})
})

// app.get('/server', function (req, res) {
//     res.setHeader('Content-Type', 'text/html');
//     res.render('./server', {ui: ui})
// })

// app.get('/complete', function (req, res) {
//     res.setHeader('Content-Type', 'text/html');
//     res.render('./complete', {ui: ui})
// })
...
// Start server.
app.listen(port)
console.log('AliCloud server listening on port', port);

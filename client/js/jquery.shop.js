(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.paypalCurrency = "RMB"; // PayPal's currency code
			this.paypalBusinessEmail = "yourbusiness@email.com"; // Your Business PayPal's account email address
			this.paypalURL = "http://1825725063814405.eventbridge.cn-guangzhou.aliyuncs.com/webhook/putEvents?token=7bd0f1663a9f43d681a92f29e9ee238b2f98e607eb634a7ab45e8bb56b0448ed9d8947ce7ceb478aa95d84756573c2dba62fb745643b478e8c415fdbdd96549c"; // The URL of the eb form
		...
		handleAddToCartForm: function() {
			...
			self.$formAddToCart.each(function() {
				...
				$form.on( "submit", function() {
					...
					// document.getElementById("totalss").value = "subTotal"
		...
		_saveFormData: function( form ) {
			...
			$visibleSet.each(function() {
				...
				if( $set.is( "#fieldset-billing" ) ) {
					...
					var hiddenTotalValuePrice = document.getElementById('totalss');
					var storeTotalValue = document.getElementById('stotal');
					var stotalvaluePrice  = storeTotalValue.innerHTML.split('￥ ')[1];
					hiddenTotalValuePrice.value = stotalvaluePrice;
